...
ansible-vault encrypt file						# encrypt file already exists
ansible-vault decrypt file --output file2 		# decrypt the file
ansible-vault rekey file						# set new a password key for encrypted file
